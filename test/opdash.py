...
class OpDashManager():
    ...
    def start(self, ip, port, exit_on_connection_fail = True, max_connection_attempts = 5, time_between_attempts = 3, listen_daemon = False):
        ...
        while True:
            try:
                ...
                if exit_on_connection_fail or connection_tries >= max_connection_attempts:
                    raise e
